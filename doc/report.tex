...
An Altera DE2-115 evaluation board featuring an Altera Cyclone IV FPGA was used as hardware platform. The resource usage of the processor is shown in Table~\ref{tab:resources}. %#TODO discussion

The maximal achievable clock frequency is \SI{29.51}{\MHz}. The critical path runs through the dispatcher (between input and output of the stall registers through the data hazard handling circuitry, s. Figure~\ref{fig:dispatcher}). %# TODO how to improve?
